...
@section('title', 'Create Asset Ruang 1')
...
<section class="asset-section">
    <nav class="breadcrumb">
        ...
        <a href="/" class="breadcrumb-item">Ruang 1</a>
        <span class="breadcrumb-separator">></span>
        <a href="{{ url('/Ruang1/asset') }}" class="breadcrumb-item">Asset Data</a>
        <span class="breadcrumb-separator">></span>
        <span class="breadcrumb-item active">Create</span>
    </nav>
    <div class="container">
        <form id="createForm" action="{{ url('/Ruang1/store') }}" method="POST">
            @csrf
            <div class="form-data">
                <div class="left-column" style="flex: 1;">
                    <div class="form-group">
                        <label for="ruangan">Ruangan</label>
                        <input type="text" id="ruangan" class="form-control" placeholder="Masukkan Ruangan" value="Ruang 1" readonly>
                    </div>
                    <div class="form-group">

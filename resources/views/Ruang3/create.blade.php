...
@section('title', 'Create Asset Ruang 3')
...
<section class="asset-section">
    ...
    <div class="container">
        <form id="createForm" action="{{ url('/Ruang3/store') }}" method="POST">
            @csrf
            <div class="form-data">
                <div class="left-column" style="flex: 1;">
                    <div class="form-group">
                        <label for="ruangan">Ruangan</label>
                        <input type="text" id="ruangan" class="form-control" placeholder="Masukkan Ruangan" value="Ruang 3" readonly>
                    </div>
                    <div class="form-group">

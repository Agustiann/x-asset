...
<section class="asset-section">
    ...
    <div class="asset-container">
        ...
        <div class="header">
            <a class="btn-create" href="{{ url('/Ruang4/create') }}"><i class='bx bx-plus-circle'></i> Create</a>
        </div>

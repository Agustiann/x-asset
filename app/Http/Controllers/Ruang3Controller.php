...
class Ruang3Controller extends Controller
{
    public function index()
    {
        return view('Ruang3.index');
    }
    public function getData(Request $request)
    {
        if ($request->ajax()) {
            $assets = Asset::where('id_ruangan', 3)
            ...
            return DataTables::of($assets)
                ...
                ->addColumn('action', function($row) {
                    return '
                        <a href="' . route('assets.edit3', $row->id) . '" class="edit"><i class="bx bx-edit"></i></a>
    ...
    {
        $assets = Asset::where('id_ruangan', 3)->get();

        return view('Ruang3.asset', compact('assets'));
    }
    public function create()
    {
        return view('Ruang3.create');
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('Ruang3.asset');
    }
    public function edit($id)
    {
        ...
        return view('Ruang3.edit', compact('asset', 'ruangan'));
    }

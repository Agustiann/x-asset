...
class Ruang2Controller extends Controller
{
    public function index()
    {
        return view('Ruang2.index');
    }
    public function getData(Request $request)
    {
        if ($request->ajax()) {
            $assets = Asset::where('id_ruangan', 2)
            ...
            return DataTables::of($assets)
                ...
                ->addColumn('action', function($row) {
                    return '
                        <a href="' . route('assets.edit2', $row->id) . '" class="edit"><i class="bx bx-edit"></i></a>
    ...
    {
        $assets = Asset::where('id_ruangan', 2)->get();

        return view('Ruang2.asset', compact('assets'));
    }

    public function create()
    {
        return view('Ruang2.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Ruang2.edit', compact('asset', 'ruangan'));
    }
